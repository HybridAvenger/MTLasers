...
import com.hybridavenger.mtlasers.common.containers.FilterCountContainer;
...
public class FilterCountScreen extends AbstractContainerScreen<FilterCountContainer> {
    private final ResourceLocation GUI = ResourceLocation.fromNamespaceAndPath(MtLasers.MODID, "textures/gui/filtercount.png");

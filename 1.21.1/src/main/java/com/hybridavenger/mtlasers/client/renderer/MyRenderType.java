package com.hybridavenger.mtlasers.client.renderer;
...
public class MyRenderType extends RenderType {
    private final static ResourceLocation laserBeam = ResourceLocation.parse(MtLasers.MODID + ":textures/misc/laser.png");
    private final static ResourceLocation laserBeam2 = ResourceLocation.parse(MtLasers.MODID + ":textures/misc/laser2.png");
    private final static ResourceLocation laserBeamGlow = ResourceLocation.parse(MtLasers.MODID + ":textures/misc/laser_glow.png");

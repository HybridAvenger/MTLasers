...
import com.hybridavenger.mtlasers.client.blockentityrenders.LaserConnectorAdvBERender;
import com.hybridavenger.mtlasers.client.blockentityrenders.LaserConnectorBERender;
import com.hybridavenger.mtlasers.client.blockentityrenders.LaserNodeBERender;
import com.hybridavenger.mtlasers.client.events.ClientEvents;
import com.hybridavenger.mtlasers.client.events.EventTooltip;
import com.hybridavenger.mtlasers.client.screens.*;
    ...
    public static void init(final FMLClientSetupEvent event) {
        ...
        event.enqueueWork(() -> {
            ItemProperties.register(Registration.Card_Item.get(),
                    ResourceLocation.fromNamespaceAndPath(MtLasers.MODID, "mode"), (stack, level, living, id) -> {

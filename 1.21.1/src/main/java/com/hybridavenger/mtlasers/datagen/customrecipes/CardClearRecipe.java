package com.hybridavenger.mtlasers.datagen.customrecipes;
...
public class CardClearRecipe implements CraftingRecipe {
    ...
    public static class Serializer implements RecipeSerializer<CardClearRecipe> {
        private static final net.minecraft.resources.ResourceLocation NAME = ResourceLocation.fromNamespaceAndPath(MtLasers.MODID, "cardclear");

package com.hybridavenger.mtlasers.common.network;

import com.hybridavenger.mtlasers.common.MtLasers;
import com.hybridavenger.mtlasers.common.network.data.*;
import com.hybridavenger.mtlasers.common.network.handler.*;
...
public class PacketHandler {
    public static void registerNetworking(final RegisterPayloadHandlersEvent event) {
        final PayloadRegistrar registrar = event.registrar(MtLasers.MODID);
